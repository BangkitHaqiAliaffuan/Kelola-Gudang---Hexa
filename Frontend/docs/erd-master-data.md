...
| **SUPPLIER**    | `id` PK, `code`, `name`, `legal_name`, `nib`, `npwp`, `phone`, `email`, `pic_name`, `website`, `address`, `city`, `bank_name`, `bank_account_no`, `bank_account_name`, `payment_terms`, `is_active`                                                                                                                  | SUP-001 / "PT Sinar Jaya Abadi" / NET 30                     |
| **CUSTOMER**    | `id` PK, `code`, `name`, `legal_name`, `nib`, `npwp`, `phone`, `email`, `pic_name`, `website`, `address`, `city`, `segment`, `bank_name`, `bank_account_no`, `bank_account_name`, `is_active`                                                                                                                        | CUS-001 / "PT Maju 1" / Distributor                          |
...
| **VENDOR**      | `id` PK, `code`, `name`, `legal_name`, `nib`, `npwp`, `service_type`, `contact_phone`, `email`, `pic_name`, `website`, `bank_name`, `bank_account_no`, `bank_account_name`, `is_active`                                                                                                                              | VDR-001 / "PT Vendor Logistik 1" / Ekspedisi                 |

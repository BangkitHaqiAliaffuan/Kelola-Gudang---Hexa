...
class ItemResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'default_rack_id' => $this->default_rack_id,
            'default_bin_id' => $this->default_bin_id,
            ...
            'supplier' => null,
            'rack' => $this->whenLoaded('rack', fn () => $this->rack?->code),
            'bin' => $this->whenLoaded('bin', fn () => $this->bin?->code),
            'stock' => $this->stock,
